...
app.post("/api/email", async (req, res) => {
    ...
    post.message.html+=(formData.firstName + " " + formData.lastName + " from " + formData.company + "</p>")
    ...
    //include email
    post.message.html+=("<p> If you'd like, you can reach me at " + formData.email + "</p>");

    //closing line
    post.message.html+="<p> Best,</p>" + "<p>" + formData.firstName + " " + formData.lastName + "</p>";
